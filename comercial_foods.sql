...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-03-2024 a las 16:07:33
...
CREATE TABLE `cliente` (
  ...
  `fecha_ingresoingreso` date DEFAULT curdate(),
...
INSERT INTO `cliente` (`cod_cliente`, `nombre1`, `nombre2`, `apellido1`, `apellido2`, `tipo_documento`, `no_documento`, `sexo`, `direccion`, `ciudad`, `fecha_ingresoingreso`, `edad`, `telefono`, `estado_civil`, `tipo_cliente`, `activo`, `empleado_cod`) VALUES
(1, 'Mario', 'Alexis', 'Aroca', 'Martínez', 'cc', '1122239857', 'masculino', 'CALLE 40 SUR #96-16', 'Bogota', '2024-03-12', 38, '3158097309', '', 'mayorista', 'A', 3),
(2, 'Jerónimo', '', 'burgos', 'diez', 'cc', '10000459', 'masculino', 'CRA 98 # 58-90', 'Bogota', '2024-03-12', 40, '9015872', '', '', 'A', 3),
(3, 'Estefanía', 'Tatiana', 'Villegas', 'sierra', 'cc', '1023581203', 'masculino', 'TRV 110 #81-40', 'Bogota', '2024-03-12', 32, '6047599', '', 'mayorista', 'A', 4),
(4, 'Guillermo', 'Mauricio', 'Fernandez', 'Vallejo', 'cc', '125692614', 'masculino', 'CALLE 75 #23SUR-40', 'Barranquilla', '2024-03-12', 43, '7057522', '', 'mayorista', 'A', 4),
(5, 'Eliana', 'Marcela', 'Ramírez', 'Guerrero', 'nit', '1222333445', 'femenino', 'Calle 181 #2-45 ', 'Barranquilla', '2024-03-12', 50, '8019053', 'viudo', 'mayorista', 'A', 5),
(6, 'José', 'Gregorio', 'Carmona', 'Guerra', 'cc', '1091562345', 'masculino', 'Cra 3 A # 5-89', 'Barranquilla', '2024-03-12', 29, '3134409180', '', 'detallista', 'A', 5),
(7, 'Marcela', 'Eliana', 'De santis', 'Rodríguez', 'cc', '1091562348', 'femenino', 'calle 9b # 4-20', 'Cali', '2024-03-12', 35, '3108156310', 'union libre', 'mayorista', 'A', 6),
(8, 'Daniela', '', 'Franco', 'Marulanda', 'cc', '1091562312', 'femenino', 'Carrera 56A No. 51 - 81', 'Cali', '2024-03-12', 45, '3212598228', 'union libre', 'mayorista', 'A', 6),
(9, 'Rafael', 'Fabian', 'Cortes', 'Palacio', 'cc', '1091562336', 'masculino', 'Calle 10 No. 9 - 78 Centro', 'Medellin', '2024-03-12', 48, '7586412', '', 'mayorista', 'A', 7),
(10, 'Camilo', 'Andres', 'Berrios', 'Bermudez', 'cc', '1091562314', 'masculino', 'Calle 24D #5676', 'Medellin', '2024-03-12', 36, '4341235', '', 'mayorista', 'A', 7),
(11, 'Francisco', 'David', 'Arias', 'Toledo', 'cc', '1091562349', 'masculino', 'calle 5b #78c 05', 'Bogota', '2024-03-12', 27, '6018954', '', 'empresarial', 'A', 8),
(12, 'Antonio', 'Giovanny', 'Merizalde', 'Arango', 'cc', '1091562103', 'masculino', 'Calle 23 #54-9', 'Barranquilla', '2024-03-12', 53, '3165846257', 'viudo', 'mayorista', 'A', 8),
(13, 'Karen', 'Rocio', 'Restrepo', 'Acevedo', 'cc', '1091562425', 'femenino', 'cra 7a # 34-89sur', 'Barranquilla', '2024-03-12', 43, '8017936', 'viudo', 'detallista', 'A', 9),
(14, 'David', 'Santiago', 'Lemus', 'Cock', 'nit', '1112239564', 'masculino', 'cr 5a #20-34 sur', 'Bogota', '2024-03-12', 55, '3412658975', '', 'mayorista', 'A', 9),
(15, 'Javier', 'Mauricio', 'Santana', 'Casadiegos', 'cc', '1233669874', 'masculino', 'CALLE 27 #58-63', 'Cali', '2024-03-12', 40, '315648301', '', 'mayorista', 'A', 10),
(16, 'Virginia', '', 'Saldarriaga', 'Salamanca', 'cc', '1556998745', 'femenino', 'cll 36 3 1-81 este', 'Medellin', '2024-03-12', 38, '4518992', '', 'detallista', 'A', 10);
...
(8, 3, 8, '2023-08-07', '2023-08-08', 340000, 's', 'Completo'),
(9, 4, 9, '2023-08-07', '2023-08-08', 250000, 's', 'Completo'),
(10, 5, 10, '2023-08-07', '2023-08-08', 270000, 's', 'Completo'),
(11, 6, 11, '2023-08-08', '2023-08-09', 320000, 's', 'Completo'),
(12, 7, 12, '2023-08-08', '2023-08-09', 220000, 's', 'Completo'),
(13, 1, 13, '2023-08-09', '2023-08-10', 350000, 's', 'Completo'),
(14, 2, 14, '2023-08-09', '2023-08-10', 280000, 's', 'Completo'),
(15, 3, 15, '2023-08-10', '2023-08-11', 330000, 's', 'Completo'),
(16, 4, 16, '2023-08-10', '2023-08-11', 265000, 's', 'Completo'),
(17, 5, 17, '2023-08-10', '2023-08-11', 320000, 's', 'Completo'),
(18, 6, 18, '2023-08-10', '2023-08-11', 280000, 's', 'Completo'),
(19, 7, 19, '2023-08-10', '2023-08-11', 260000, 's', 'Completo'),
(20, 1, 20, '2023-08-10', '2023-08-11', 370000, 's', 'Completo'),
(21, 2, 21, '2023-08-11', '2023-08-12', 230000, 's', 'Completo'),
(22, 3, 22, '2023-08-11', '2023-08-12', 240000, 's', 'Completo'),
(23, 4, 23, '2023-08-11', '2023-08-12', 270000, 's', 'Completo'),
(24, 5, 24, '2023-08-11', '2023-08-12', 240000, 's', 'Completo'),
(25, 6, 25, '2023-08-12', '2023-08-13', 250000, 's', 'Completo'),
(26, 7, 26, '2023-08-12', '2023-08-13', 260000, 's', 'Completo'),
(27, 1, 21, '2023-08-13', '2023-08-14', 320000, 's', 'Completo'),
(28, 2, 22, '2023-08-13', '2023-08-14', 300000, 's', 'Completo'),
(29, 3, 23, '2023-08-13', '2023-08-14', 310000, 's', 'Completo'),
(30, 4, 24, '2023-08-13', '2023-08-14', 310000, 's', 'Completo'),
(31, 5, 25, '2023-08-13', '2023-08-14', 230000, 's', 'Completo'),
(32, 6, 26, '2023-08-14', '2023-08-15', 250000, 's', 'Completo'),
(33, 7, 27, '2023-08-14', '2023-08-15', 260000, 's', 'Completo'),
(34, 1, 28, '2023-08-14', '2023-08-15', 270000, 's', 'Completo'),
(35, 2, 29, '2023-08-15', '2023-08-16', 290000, 's', 'Completo'),
(36, 3, 30, '2023-08-15', '2023-08-16', 300000, 's', 'Completo'),
(37, 4, 31, '2023-08-15', '2023-08-16', 320000, 's', 'Completo'),
(38, 5, 32, '2023-08-15', '2023-08-16', 280000, 's', 'Completo'),
(39, 6, 33, '2023-08-15', '2023-08-16', 350000, 's', 'Completo'),
(40, 7, 34, '2023-08-15', '2023-08-16', 260000, 's', 'Completo'),
(41, 1, 35, '2023-08-15', '2023-08-16', 320000, 's', 'Completo'),
(42, 2, 36, '2023-08-16', '0000-00-00', 350000, 's', 'Completo'),
(43, 3, 37, '2023-08-16', '0000-00-00', 400000, 's', 'Completo'),
(44, 4, 38, '2023-08-16', '0000-00-00', 350000, 's', 'Completo'),
(45, 5, 39, '2023-08-16', '0000-00-00', 320000, 's', 'Completo');
...
CREATE TABLE `empleado` (
  ...
  `nivel_estudios` enum('primaria','bachillerato','tecnico','tegnologo','profesional','otro') DEFAULT NULL,
...
(5, 'Hilda', '', 'Rodriguez', 'Caro', 'cc', '1020567980', 'femenino', 'Av 68 # 5a _45', 'bogota', 31, '3025975960', '2024-03-12', 'casado', 2, 'profesional', 'sanitas', 'porvenir', 'proteccion', '', 'A'),
(6, 'Victoria', '', 'Hincapie', 'Vergara', 'cc', '19654789', 'femenino', 'Calle 10 # 5-51', 'medellin', 22, '3103336590', '2024-03-12', 'union libre', 2, '', 'sura', 'porvenir', 'colfondos', 'popular', 'A'),
...
(9, 'Stepania', '', 'Zapata', 'Pelaez', 'cc', '1014343567', 'femenino', 'Carrera 21 # 17 -63', 'cali', 25, '3028912345', '2024-03-12', 'casado', 2, '', 'sanitas', 'porvenir', 'fna', 'davivienda', 'A'),
...
(14, 'Rocio', '', 'Muñoz', 'Gutierrez', 'cc', '1015768903', 'femenino', 'CR 5B #50-49A SUR', 'barranquilla', 37, '3125847512', '2024-03-12', 'casado', 3, 'tecnico', 'sura', 'porvenir', 'porvenir', 'BBVA', 'A');
...
(14, '2023-08-09', 11, 8, '', 1),
(15, '2023-08-10', 11, 9, '', 1),
(16, '2023-08-11', 12, 9, '', 1),
(17, '2023-08-11', 12, 10, '', 1),
(18, '2023-08-12', 13, 10, '', 1),
(19, '2023-08-12', 13, 5, 'credito', 1),
(20, '2023-08-13', 14, 6, 'credito', 1),
(21, '2023-08-13', 14, 4, '', 1),
(22, '2023-08-14', 15, 8, '', 1),
(23, '2023-08-15', 16, 9, '', 3),
(24, '2023-08-15', 10, 7, '', 3),
(25, '2023-08-16', 3, 5, '', 3),
(26, '2023-08-16', 5, 3, '', 3),
(27, '2023-08-17', 8, 11, '', 1),
(28, '2023-08-17', 4, 10, '', 1),
(29, '2023-08-17', 8, 7, '', 1),
(30, '2023-08-18', 9, 4, 'credito', 1),
(31, '2023-08-18', 2, 9, '', 1),
(32, '2023-08-18', 6, 7, '', 1),
(33, '2023-08-19', 13, 3, '', 1),
(34, '2023-08-19', 8, 8, 'credito', 1),
(35, '2023-08-20', 14, 5, '', 1),
(36, '2023-08-20', 15, 3, '', 1),
(37, '2023-08-21', 16, 6, '', 1),
(38, '2023-08-21', 11, 8, '', 1),
...
(10, 'Salchiperro vaquera x pq', 6500, 7500, 8500, 4072, '2023-08-30', '2023-09-02', 7, 8),
...
CREATE TABLE `proveedor` (
  ...
  `asesor_comercal` varchar(50) NOT NULL,
  `telefono_asesor` int(11) NOT NULL,
...
INSERT INTO `proveedor` (`cod_proveedor`, `razon_social`, `tipo_documento`, `direccion`, `ciudad`, `telefono`, `e_mail`, `asesor_comercal`, `telefono_asesor`, `e_mail_asesor`) VALUES
(1, 'Devolución Buena', '', 'N/A', 'BOGOTA', 'N/A', 'N/A', 'N/A', 0, 'N/A'),
...
(4, 'PAN MIMOS', 'NIT', 'CRA 31A No.10-78', 'BUCARAMANGA', '2084765', 'atencioncliente@mimos.co', 'ROCIO MORENO', 2147483647, 'carlos.moreno@mimos.co'),
(5, 'LACTEOS VAQUERIA', 'NIT', 'CRA 20 No.22-48', 'MEDELLIN', '76712474', 'serviciocliente@vaqueria.co', 'AMAYA', 2147483647, 'ramayacalinca@vaqueria.co'),
(6, 'BEBIDAS YAYOS', 'NIT', 'CRA 24 NO.54-32', 'BARRANQUILLA', '68856743', 'clientes@yayos.co', 'FREDY CARDENAS', 2147483647, 'fredy.cardenas@yayos.co'),
(7, 'SALSAS PIRRY', 'NIT', 'CLL 12A No.37-122', 'CALI', '24457740', 'servicioalcliente@pirry.com', 'SONIA VIVAS', 2147483647, 'soniavivas@pirry.com'),
(8, 'CARNICOS COWS', 'NIT', 'CLL 220A No.7-122', 'BOGOTA', '24457735', 'servicioalcliente@cows.com', 'BARTIMEO RIOS', 2147483647, 'Bartimeo rios@cows.com');
...
ALTER TABLE `factura_cabeza`
  ...
  ADD KEY `empleado_cod` (`empleado_cod`),
  ADD KEY `fk_tipomov` (`tipomov_cod`);
...
ALTER TABLE `factura_cabeza`
  ...
  ADD CONSTRAINT `fk_tipomov` FOREIGN KEY (`tipomov_cod`) REFERENCES `tipomov` (`cod_tipomov`) ON DELETE CASCADE ON UPDATE CASCADE;
